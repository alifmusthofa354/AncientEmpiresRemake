...
public final class Unit extends Sprite
{
	...
	public final void paint(SpriteBatch var1, int var2, int var3)
	{
		paintEx(var1, var2, var3, false);
	}

	public final void paintEx(SpriteBatch g, int x, int y, boolean gray)
	{
		if(unitState != 4)
		{
			int var6;
	...
	public final void drawHealthString(SpriteBatch var1, int var2, int var3)
	{
